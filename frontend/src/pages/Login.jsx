...
return ( <div className="w-full flex flex-col items-center py-1"> <div className="w-full max-w-sm">
  ...
  >
    Forgot Password?
      ...
      <button
        ...
        className="mt-4 w-full rounded-full border border-dashed border-indigo-200 bg-indigo-50/20 py-2 text-[10px] font-bold text-indigo-500 hover:bg-indigo-50 transition-colors"
      >
        Quick Dev Access
      </button>
